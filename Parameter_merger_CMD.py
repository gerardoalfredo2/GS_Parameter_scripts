...
def parameter_compacter(Input_folder, OutPut_file):
    ...
    for file_ in files:
         ...
         try:
             ...
             for key in params:
                 not_needed=["Date",'RNC_name',"RNCName","RNC_Name","id","Id","Id_2","vsDataType","vsDataFormatVersion","Area_Name","AreaName","EnodeBId","Id2","Id3","Id4","CellId"]
...
parameter_compacter('C:\\Users\\VervebaMX2\\Documents\\Projects\\XML_Parsing\\TEst\\Test_allEricssonXMLLTE\\Results\\','C:\\Users\\VervebaMX2\\Documents\\Projects\\XML_Parsing\\TEst\\Test_allEricssonXMLLTE\\')
...
#     parameter_compacter(first_arg,second_arg)   
